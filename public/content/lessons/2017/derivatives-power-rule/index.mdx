...
Let’s try a different simple function, $f(x) = x^3$. This will be the geometric view of what you and I went through algebraically in the last chapter for the function $x^2$. We can think of $x^3$ geometrically as the volume of a cube with side lengths $x$.
